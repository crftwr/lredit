...
class MessageBox( ckit.TextWindow ):
    ...
    def __init__( self, x, y, parent_window, ini, msgbox_type, title, message, return_modkey ):
    ...
    def paint(self):
        ...
        if self.msgbox_type==MSGBOX_TYPE_OK:
            ...
            btn1_string = " " + ckit.strings["common_yes"] + " "
            btn1_width = self.getStringWidth(btn1_string)
            btn2_string = " " + ckit.strings["common_no"] + " "
...
#    - lredit_msgbox.MSGBOX_RESULT_CANCEL \n
#       キャンセルされた\n\n
#
#    - lredit_msgbox.MSGBOX_RESULT_OK \n
#       [ OK ]ボタンが選択された\n\n
#
#    - lredit_msgbox.MSGBOX_RESULT_YES \n
#       [ はい ]ボタンが選択された\n\n
#
#    - lredit_msgbox.MSGBOX_RESULT_NO \n
#       [ いいえ ]ボタンが選択された\n\n
#
def popMessageBox( main_window, msgbox_type, title, message, return_modkey=False ):
    pos = main_window.centerOfWindowInPixel()
    msgbox = MessageBox( pos[0], pos[1], main_window, main_window.ini, msgbox_type, title, message, return_modkey )
