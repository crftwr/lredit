...
class ListWindow( ckit.TextWindow ):
    ...
    def show( self, visible, activate=True ):
    ...
    def command_IncrementalSearch( self, info ):
        ...
        self.isearch = lredit_isearch.IncrementalSearch(self.ini)
...
def popMenu( main_window, title, items, initial_select=0, onekey_search=True, onekey_decide=False, return_modkey=False, keydown_hook=None, statusbar_handler=None ):
    ...
    list_window = ListWindow( pos[0], pos[1], 5, 1, main_window.width()-5, main_window.height()-3, main_window, main_window.ini, True, title, items, initial_select=initial_select, onekey_search=onekey_search, onekey_decide=onekey_decide, return_modkey=return_modkey, keydown_hook=keydown_hook, statusbar_handler=statusbar_handler )
